...
export const validateScheduleBody = z.object({
  name: z
    ...
    .min(3, { message: "Name length is too short (minimum 3 characters)" })
    .max(50, { message: "Name length is too long (maximum 50 characters)" }),
...
export type ValidateScheduleBodyT = z.infer<typeof validateScheduleBody>;
