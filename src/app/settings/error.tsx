...
export default function Error({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] md:min-w-[500px] space-y-3">
      <h1 className="scroll-m-20 text-red-700 dark:text-neutral-300 text-4xl font-extrabold tracking-tight lg:text-5xl">
        4:00 | Error Occured
      </h1>
      <p className="text-primary text-neutral-400">{error.message}</p>
